...
def main() -> int:
    for path in (FEATURES_MD, RUNBOOK_MD, DOCS_INDEX_MD, OPS_README_MD):
        require_file(path)
    ...
    if "OPERATOR_RUNBOOK.md" not in docs_index_text or "FEATURES.md" not in docs_index_text:
        missing_links.append(
            "ops/docs/README.md must link OPERATOR_RUNBOOK.md and FEATURES.md"
        )
